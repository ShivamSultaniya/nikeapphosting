  ...
  return (
    <div className="lg:py-32 py-16 lg:px-16 px-8" id="contact-us">
      <div className="container mx-auto px-3 flex justify-between items-center max-lg:flex-col gap-10 w-full">
        ...
        <div className="lg:max-w-[40%] w-full flex items-center max-sm:flex-col gap-5 p-2.5 sm:border-solid sm:border sm:border-[#606060] rounded-full">
          <input
            type="email"
            placeholder="Subscribe@nike.com"
            className="w-full rounded-full text-[#60606D] p-5 sm:border-none border border-solid outline-none lg:flex-1"
          />
